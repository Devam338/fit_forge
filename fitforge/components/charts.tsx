    ...
    <div className="chart-placeholder">
      <ResponsiveContainer width="100%" height="100%"> 
        <BarChart data={data}>
          ...
          <Tooltip />
          <Legend />
          <Bar dataKey="consumed" fill="#34c97b" radius={[7,7,2,2]} /> 
          <Bar dataKey="burned" fill="#f97316" radius={[7,7,2,2]} /> 
        </BarChart>
      </ResponsiveContainer>
    </div> 
  );
    ...
    <div className="chart-tall">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data}>
          ...
          <Tooltip />
          <Legend />
          <Bar dataKey="completed" fill="#34c97b" radius={[5,5,2,2]} />
          <Bar dataKey="planned" fill="#94a3b8" radius={[5,5,2,2]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
